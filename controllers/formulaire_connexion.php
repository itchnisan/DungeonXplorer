...
<html lang="fr">
  ...
  <body>
    <form id="formulaireConnexion" name="formulaireConnexion" action = "traitement_connexion.php" method="post">
    ...
    <form id="formulaireDeconnexion" name="formulaireDeconnexion" action = "traitement_deconnexion.php" method="post">
